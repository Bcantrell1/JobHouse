...
<div class="container d-flex flex-column justify-content-center align-items-center " id="login-box">
    ...
    <div class="submit-row" style="margin-bottom:8px;padding-top:0px;">
        <button class="btn btn-block my-3" id="submit-id-submit" type="submit" style="background-color:#F58A07;">
            Login
        </button>
    ...
    <div id="login-box-footer">
        <p>Don't you have an account yet?<a id="register-link" href="{{ url('register') }}">Register Now!</a></p>
    </div>
</div>
@endsection()